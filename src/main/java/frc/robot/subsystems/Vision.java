...
public class Vision extends SubsystemBase {
  ...
  MjpegServer mjpegServer2;

  Mat mat;
  // shuffleboard tab
  ShuffleboardTab _tab = Shuffleboard.getTab("Vision");
  // shuffleboard widget
  ComplexWidget visionWidget = _tab.add("outputStream", outputStream).withPosition(0, 0).withSize(0, 0);
  ...
  public Vision() {
    ...
    m_visionThread = new Thread(
        () -> {
          ...
          MjpegServer mjpegServer2 = new MjpegServer("serve_Filtered", 1182);
